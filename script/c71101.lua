...
function c71101.negcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_REMOVED) and Duel.GetTurnPlayer()==tp and (Duel.GetCurrentPhase()>PHASE_MAIN1 and Duel.GetCurrentPhase()<PHASE_MAIN2) and not Duel.CheckPhaseActivity() and Duel.GetCurrentChain()==0
end
