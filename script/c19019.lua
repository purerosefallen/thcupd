...
function c19019.initial_effect(c)
		...
		--fusion material
		c:EnableReviveLimit()
		Fus.AddFusionProcFunMulti(c,insf,aux.FilterBoolFunction(Card.IsSetCard,0x713),aux.FilterBoolFunction(Card.IsSetCard,0x226),aux.FilterBoolFunction(Card.IsSetCard,0x190))
