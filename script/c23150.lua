...
function c23150.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fus.AddFusionProcFun2(c,aux.FilterBoolFunction(Card.IsSetCard,0x497),aux.FilterBoolFunction(c23150.fusfilter),true)
	--search
...
aux.FilterBoolFunction(c23150.fusfilter),
}
